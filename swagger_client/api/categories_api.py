...
class CategoriesApi(object):
    ...
    def get_month_category_by_id(self, budget_id, month, category_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param ERRORUNKNOWN budget_id: The id of the budget (\"last-used\" can also be used to specify the last used budget) (required)
        :param ERRORUNKNOWN month: The budget month in ISO format (e.g. 2016-12-30) (\"current\" can also be used to specify the current calendar month (UTC)) (required)
        :param ERRORUNKNOWN category_id: The id of the category (required)
        :return: CategoryResponse
                 If the method is called asynchronously,
                 returns the request thread.
    ...
    def update_month_category(self, budget_id, month, category_id, month_category, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_month_category(budget_id, month, category_id, month_category, async_req=True)
        >>> result = thread.get()
    ...
    def update_month_category_with_http_info(self, budget_id, month, category_id, month_category, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_month_category_with_http_info(budget_id, month, category_id, month_category, async_req=True)
        >>> result = thread.get()
